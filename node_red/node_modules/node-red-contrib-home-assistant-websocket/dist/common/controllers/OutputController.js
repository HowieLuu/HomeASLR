...
class OutputController {
    constructor({ nodeRedContextService, node, state, status, typedInputService, }) {
        var _a, _b, _c;
    ...
    setEnabled(value) {
        var _a;
        (_a = this.state) === null || _a === void 0 ? void 0 : _a.setEnabled(value);
    }
    ...
    setCustomOutputs(properties = [], message, extras) {
        properties.forEach((item) => {
            const value = this.typedInputService.getValue(item.value, item.valueType, {
                message,
                ...extras,
            });
            try {
