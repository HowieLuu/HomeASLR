...
class ComparatorService {
    ...
    getComparatorResult(comparatorType, // is, is not, less, greater, less or equal, greater or equal
    ...
    { message, entity, prevEntity, } = {}) {
        ...
        if ((0, NodeRedContextService_1.isContextLocation)(comparatorValueDatatype)) {
            ...
            comparatorValue) {
            cValue = __classPrivateFieldGet(this, _ComparatorService_jsonataService, "f").evaluate(comparatorValue, {
                message,
                entity,
                prevEntity,
            });
        ...
        switch (comparatorType) {
            ...
            case 'jsonata':
                if (!cValue)
                    return true;
                return (__classPrivateFieldGet(this, _ComparatorService_jsonataService, "f").evaluate(cValue, {
                    message,
                    entity,
                    prevEntity,
                }) === true);
