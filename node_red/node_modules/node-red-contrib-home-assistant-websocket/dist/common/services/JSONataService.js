...
class JSONataService {
    ...
    evaluate(expression, objs = {}) {
        const expr = globals_1.RED.util.prepareJSONataExpression(expression, __classPrivateFieldGet(this, _JSONataService_node, "f"));
        ...
        try {
            return globals_1.RED.util.evaluateJSONataExpression(expr, message);
        }
        catch (err) {
