...
var _EventsStatus_instances, _EventsStatus_connectionState, _EventsStatus_onClientClose, _EventsStatus_onClientConnecting, _EventsStatus_onClientError, _EventsStatus_onClientOpen, _EventsStatus_onClientRunning, _EventsStatus_updateConnectionStatus, _EventsStatus_getConnectionStatus;
...
_EventsStatus_connectionState = new WeakMap(), _EventsStatus_instances = new WeakSet(), _EventsStatus_onClientClose = function _EventsStatus_onClientClose() {
    ...
    __classPrivateFieldGet(this, _EventsStatus_instances, "m", _EventsStatus_updateConnectionStatus).call(this);
}, _EventsStatus_onClientError = function _EventsStatus_onClientError() {
    ...
    const status = __classPrivateFieldGet(this, _EventsStatus_instances, "m", _EventsStatus_getConnectionStatus).call(this);
    status.text = globals_1.RED._(`${status.text}`);
    this.lastStatus = status;
    this.updateStatus(status);
}, _EventsStatus_getConnectionStatus = function _EventsStatus_getConnectionStatus() {
    const status = {
