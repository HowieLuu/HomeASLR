...
const SwitchEntityStatus_1 = __importDefault(require("../../common/status/SwitchEntityStatus"));
...
function switchNode(config) {
    ...
    const status = new SwitchEntityStatus_1.default({
    ...
    new SwitchController_1.default({
        entityConfigEvents,
        entityConfigNode,
        inputService,
        node: this,
