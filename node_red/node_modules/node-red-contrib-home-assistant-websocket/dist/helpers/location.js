...
function getLocationData(entity) {
    ...
    return (0, geolib_1.isValidCoordinate)(coord) ? coord : false;
}
exports.getLocationData = getLocationData;
function getZoneData(zone) {
    var _a;
    const data = getLocationData(zone);
    if (data === false || ((_a = zone === null || zone === void 0 ? void 0 : zone.attributes) === null || _a === void 0 ? void 0 : _a.radius) === undefined)
        return false;
